<template>
  <div class="search-page">
    <div class="gradient-section">
      <h1 class="search-title">Carrito</h1>
    </div>
    <img class="hero-image" src="@/assets/img/search.jpg" />
    <div class="section">
      ...
      <div class="checkout-card">
        <div class="header-checkout">
          <p class="checkout-title">Cuenta total</p>
        </div>
        <div class="body-checkout">
          <p class="text-box">Subtotal : ${{ cartTotalPrice }}</p>
          <p class="text-box">Envio : ${{ getShipping }}</p>
          <p class="text-box">IVA: {{ getTax }}%</p>
          <p class="text-total">Total ${{ cartCheckoutPrice }}</p>
        </div>
        <div class="footer-checkout" to="/checkout">
          <div class="checkout" @click.prevent="orderSuccess()">Comprar</div>
        </div>
      </div>
    </div>
  </div>
